...
export const projects = [
  {
    ...
    techStack: ['React', 'Node.js', 'Express', 'Vercel', 'Tailwind CSS', 'Render', '1 Years ago'],
    image: '/QuarkAi.png',
  ...
  },
  {
    ...
    techStack: ['React', 'Node.js', 'Vercel', 'Tailwind CSS', 'Render', 'Supabase', 'PostgerSQL', '1 Years ago'],
    image: '/NTS.png',
