      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <Card className="animate-fade-up">
          ...
          <p className="mt-4 text-sm leading-7 text-neutral-600 dark:text-neutral-400">
            If you have a project you want to launch, improve, or scale, send me a message.
            I appreciate clear communication, thoughtful products, and teams that care
            about building things well.
          </p>
